# The Matrix黑客帝国屏保
## 来源
[代码来源](https://blog.csdn.net/huan_chen/article/details/52692777)
[操作步骤来源](https://zhuanlan.zhihu.com/p/97608960)
## 效果图：
![效果图](assets/Matrix.png)
## 操作步骤：
1. 打开VS2013或以上版本，新建—>项目,Visual C++，win32，选择win32控制台应用程序，名称填写为"hacker"。
...
5. 将文件hacker.scr拷贝到C:\Windows\System32下

6. 鼠标移到桌面，右击，选择个性化，屏幕保护程序，选择hacker。

属于自己的黑客帝国屏幕保护程序就设置成功啦！
...
{   
    return (TCHAR)(rand()%2+0x30); //33到126之间   
}  
